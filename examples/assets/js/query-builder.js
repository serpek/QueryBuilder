...
(function(root, factory) {
    if (typeof define == 'function' && define.amd) {
        define(['jquery', '../../../bower_components/doT/doT', 'jQuery.extendext'], factory);
    }
    else {
...
QueryBuilder.OPERATORS = {
    ...
    less:             { type: 'less',             nb_inputs: 1, multiple: false, apply_to: ['number', 'datetime','waypoint'] },
    less_or_equal:    { type: 'less_or_equal',    nb_inputs: 1, multiple: false, apply_to: ['number', 'datetime','waypoint'] },
    greater:          { type: 'greater',          nb_inputs: 1, multiple: false, apply_to: ['number', 'datetime','waypoint'] },
    greater_or_equal: { type: 'greater_or_equal', nb_inputs: 1, multiple: false, apply_to: ['number', 'datetime','waypoint'] },
